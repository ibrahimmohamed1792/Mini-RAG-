...
class ProcessController(BaseController):
    ...
    def get_file_extension(self,file_id:str):
        return os.path.split(file_id)[-1]
    
    def get_file_loader(self,file_id:str):
        file_ext=self.get_file_extension(file_id=file_ext)
    ...
    def process_file_content(slef ,file_content:list,file_id:str,chunk_size:int=100,overlap_size:int=20):
        ...
        file_content_metadata=[rec.metadata
                               for rec in file_content]
